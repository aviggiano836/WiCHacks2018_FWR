...
public class ExpDateTracker extends ProductDatabase{
	 ...
	 //To-do list
	//Using Wegmans api, create prototype "Availability checker" for produce
	//Store "expiring soon" products in "To Donate" array
	...
	public static void prodIterator(String prodCategory, int curDay) { 
		...
		if(prodCategory.equals("Fruit")) //instead of repeating this entire process, lets have this and the next line repeated. put the for loop at the end. by the end, prod list will be whatever category passed the if statement
			prodList = addFruit();
